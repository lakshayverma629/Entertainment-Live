...
<div class="wrapper_website">
    <jsp:include page="htmls/header.html"></jsp:include>
        ...
        <jsp:include page="htmls/sidebar.html"></jsp:include>
        	<div class="heading" align="center">Most Played Songs</div>
...
try
{
	...
	ps=con.prepareStatement("select * from song where sid IN(select sid from last_play group by sid having count(sid)>2)");
