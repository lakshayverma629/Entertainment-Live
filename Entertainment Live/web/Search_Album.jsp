<%-- 
    Document   : Search_Album
    Created on : 19 Nov, 2014, 6:26:01 PM
    Author     : lakshay
--%>
...
<html>
	...
	<div id="bg_img">
		...
		i++;
			...
			ps=con.prepareStatement("select * from song where album=?");
...

{
		...
		<td>
		<a href="songs/check_if_logged_in.jsp?sid=<%=sid%>" target="_blank">Download</a>
		</td>
		<td>
		<ul class="lb-album">
							<li>
